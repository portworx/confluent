...
integration tests and provides global setup/teardown fixtures
"""
import logging
import os
import subprocess
...
# use the lazy autouse hack apply this to all tests
@pytest.fixture(scope='session', autouse=True)
def configure_security(configure_universe):
    yield from sdk_security.security_session('confluent-kafka')
